...
subtest 'Runner Plain Text Result' => sub {
  ...
  $sscriptsummary = $1 if ($srunnerresult =~ qr/>>>>summary:\n(.*)>>>>stdout/si);
  ...
  is($iscriptstatus, $iteststatus, "Script EXIT CODE '$iteststatus' is correct");
...
subtest 'Runner JSON Result' => sub {
  ...
  eval {
    $runnerresult = decode_json($srunnerresult);
  };
...
subtest 'Runner YAML Result' => sub {
  ...
  eval {
    $runnerresult = Load($srunnerresult);
  };
...
subtest 'Runner Plain Text Boundary' => sub {
  ...
  $sscriptsummary = $1 if ($srunnerresult =~ /${soutputboundary}summary:\n(.*)${soutputboundary}stdout/si);
  $sscriptlog = $1 if ($srunnerresult =~ /${soutputboundary}stdout:\n(.*)${soutputboundary}stderr/si);
  $scripterror = $1 if ($srunnerresult =~ /${soutputboundary}stderr:\n(.*)${soutputboundary}end/si);
...
subtest 'Runner Timeout Error' => sub {
  ...
  if(defined $scripterror)
  {
    ...
    isnt($scripterror, '', "Script STDERR was captured");
    ok($scripterror =~ qr/Execution timed out/i, "Script STDERR 'timed out' is correct");
  } #if(defined $rscripterror)
};
...
subtest 'Runner Exit Code' => sub {
  ...
  subtest 'Runner returns Error Code' => sub {
    ...
    if(defined $scripterror)
    {
      ...
      isnt($scripterror, '', "Script STDERR was captured");
      ok($scripterror =~ qr/Execution timed out/i, "Script STDERR 'times out' is correct");
    } #if(defined $rscripterror)
  };
};
